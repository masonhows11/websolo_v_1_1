    ...
    <div class="container">
        <div class="row d-flex justify-content-center article-section-create">
            ...
            <div class="col-xl-12 col-lg-10 col-md-10">
                ...
                <form action="{{ route('admin.training.update') }}" method="post">
                    @csrf
                    ...
                    <div class="my-5 form-group">
                        ...
                        <textarea class="form-control @error('short_description') is-invalid @enderror"
                                  ...
                                  name="short_description">{{ $training->short_description  }}</textarea>
                    </div>
