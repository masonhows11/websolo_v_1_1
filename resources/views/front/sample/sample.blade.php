                ...
                <div class="row my-3 wk-sample-section w3-flat-midnight-blue rounded-3">
                    <div class="col-xxl-12 col-xl-10 col-lg-10 col-md-10 my-2">
                        ...
                        <div
                            ...
                            <div class="col d-flex flex-column wk-sample-info  align-content-center justify-content-around">
                ...
                <div
                    ...
                    <div class="col my-5 sample-main-image">
                        <img src="{{ asset('storage/samples/' . $sample->image1) }}" class="img-thumbnail h-100"
                            loading="lazy" alt="sample-gallery-image" data-bs-toggle="modal" data-bs-target="#imageModal_1">
                    </div>
                    <div class="col my-5 sample-main-image">
                        <img src="{{ asset('storage/samples/' . $sample->image2) }}" class="img-thumbnail h-100"
                            loading="lazy" alt="sample-gallery-image" data-bs-toggle="modal" data-bs-target="#imageModal_2">
                    </div>
                    <div class="col my-5 sample-main-image">
                        <img src="{{ asset('storage/samples/' . $sample->image3) }}" class="img-thumbnail h-100"
                            loading="lazy" alt="sample-gallery-image" data-bs-toggle="modal" data-bs-target="#imageModal_3">
                    </div>
                    <div class="col my-5 sample-main-image">
                        <img src="{{ asset('storage/samples/' . $sample->image4) }}" class="img-thumbnail h-100"
                            loading="lazy" alt="sample-gallery-image" data-bs-toggle="modal" data-bs-target="#imageModal_4">
                    </div>
                </div>
                ...
                <form id="add-comment">
                    @auth
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="متن دیدگاه خود را وارد کنید." id="body-comment" rows="6">
                            </textarea>
                        </div>
                        <div class="mb-3 mt-3">
